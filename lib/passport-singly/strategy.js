...
function Strategy(options, verify) {
  ...
  options.authorizationURL = options.authorizationURL || options.hostURL + '/oauth/authorize';
  options.tokenURL = options.tokenURL || options.hostURL + '/oauth/access_token';
 ...
 *
 * If the service name provided on the request (url segment, then querystring) for the service
 * parameter it will override whatever comes on the options. This enables override defaults.
 *
 * @param {Object} req
 * @api protected
 */
