 ...
 * 
 * If the service name isn't provided on the options it will look on the request
 * (url segment, then querystring) for the service parameter.
 *
 * @param {Object} req
 * @api protected
 */
Strategy.prototype.authenticate = function(req, options) {
  if(!options['service']){
    options['service'] = (req.params['service'] || req.query['service']);
  }
