 ...
 * 
 * If the service name isn't provided on the options it will look on the params 
 * (body, form, query) for the service parameter.
 *
 * @param {Object} req
 * @api protected
 */
Strategy.prototype.authenticate = function(req, options) {
  if(!options['service']){
    options['service'] = req.params('service');
  }
