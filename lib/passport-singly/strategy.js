...
Strategy.prototype.authenticate = function(req, options) {
  var overrideService = (req.params['service'] || req.query['service']);

  if(overrideService) 
    options['service'] = overrideService;

  var overrideAccount = req.query['account'];
 ...
 *  - `account`   If an existing account is known and this auth should connect the new profile 
 *                into an existing account. Use false to force login/signup.
 *
 * @param {Object} options
 * @return {Object}
 * @api protected
